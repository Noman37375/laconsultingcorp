...
export default function Hero() {
  return (
    <div className="relative min-h-[500px] flex items-center justify-center bg-cover bg-center bg-fixed"
      style={{
    ...
    >
      ...
      <div className="relative text-center text-white z-10 px-4 max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
          GA4 Website Audit Services
        </h1>
        <p className="text-lg md:text-xl mb-8 text-gray-200 max-w-2xl mx-auto leading-relaxed">
          Unlock the full potential of your website with our comprehensive GA4 audit services
        </p>
        <div className="flex items-center justify-center space-x-4">
          ...
          <div className="flex items-center text-sm space-x-2 bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm">
            ...
            <span className="text-blue-300">GA4 AUDIT</span>
          </div>
        </div>
      </div>
    </div>
